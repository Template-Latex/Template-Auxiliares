...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={7.2.2-2-AUX},
		Template.Version.Hash={0C2592C4F2D6DBDFF3A1B84D4A95997C},
		Template.Version.Release={7.2.2},
	...
	pdfproducer={Template-Auxiliares v7.2.2 | (Pablo Pizarro R.) ppizarror.com},
