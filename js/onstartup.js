...
$.getJSON("https://api.github.com/repos/ppizarror/Template-Auxiliares/releases", function(json) {
    ...
    try {
        ...
        new_version_entry += "Puedes ver la lista de cambios completa <a href='https://github.com/ppizarror/Template-Auxiliares/releases'>en Github<img src='resources/github.png' width='16px' height='16px' class='iconbutton' /></a>";
