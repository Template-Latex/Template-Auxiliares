...
$.getJSON("https://api.github.com/repos/ppizarror/Template-Auxiliares/releases", function(json) {
    ...
    msg_download_normal = '{1} <font style="color: #333333;">({0})</font> <img src="resources/zip.png" width="16px" height="16px" style="top:4px; position:relative; margin-left:5px" />'
    msg_download_compact = '{1} <font style="color: #999999;">({0})</font> <img src="resources/zip.png" width="16px" height="16px" style="top:4px; position:relative; margin-left:5px" />'
