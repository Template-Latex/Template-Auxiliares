...
\ifthenelse{\equal{\usepdfmetadata}{true}}{
	...
	\def\pdfmetainfotitulo {\tituloauxiliar}
...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={7.0.0-alpha-1-AUX-N},
		Template.Version.Hash={10217C501BE78456E767C3CE111476E5},
	...
	pdfproducer={Template-Auxiliares v7.0.0 | (Pablo Pizarro R.) ppizarror.com},
