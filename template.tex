...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={8.3.7-AUX},
		Template.Version.Hash={0EDDDE1D5D78412F3D0B7EA309C4445C},
	...
	pdfproducer={Template-Auxiliares v8.3.7 | (Pablo Pizarro R.) ppizarror.com},
