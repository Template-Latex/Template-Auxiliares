...
% Ancho final al que \itemresize escala su contenido
\newlength{\itemresizewidth}

% Corrige el ancho de las notas de threeparttable tras un \itemresize.
% threeparttable mide la tabular para fijar el ancho del caption y de las
% notas, pero dentro de \resizebox esa medida es el ancho natural y no el
% ancho final: las notas quedan más anchas (o más angostas) que la tabla y
% se salen de la columna. Fuera de un threeparttable no hace nada.
\makeatletter
\newcommand{\itemresizetpthsize}{%
	\@ifundefined{TPT@LA@caption}{}{%
		\ifx\TPT@LA@caption\relax\else%
			\hsize\itemresizewidth%
...
\newcommand{\itemresize}[2]{%
	...
	\setlength{\itemresizewidth}{#1\linewidth}%
	\resizebox{\itemresizewidth}{!}{#2}%
	\itemresizetpthsize%
}
...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={8.4.4-AUX},
		Template.Version.Hash={A9DD8FD78214915B4F5BF05DE1F8FC32},
		Template.Version.Release={8.4.4},
		Template.Web.Dev={https://github.com/Template-Latex/Template-Auxiliares},
		Template.Web.Manual={https://template-latex.github.io/auxiliares},
	...
	pdfproducer={Template-Auxiliares v8.4.4 | (Pablo Pizarro R.) ppizarror.com},
