...
Este corresponde a un template para confeccionar [geniales auxiliares en latex](https://github.com/ppizarror/Template-Auxiliares/blob/master/main.pdf), contiene funciones básicas para agregar imágenes, párrafos, fórmulas, etc.
